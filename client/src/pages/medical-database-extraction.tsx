        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              {/* LEQVIO Patient Information - Show immediately after extraction */}
        ...
        {extractedData && editableData && (
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {/* For LEQVIO forms, patient data is already displayed at the top - just show a summary */}
              {editableData.provider_name !== undefined && editableData.signature_date !== undefined ? (
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-700">
                    Patient information is displayed at the top of the page for easy editing. 
                    Use the "Reset to Original" button above to restore extracted values.
                  </p>
                </div>
              ) : (
